...
public sealed class MenuDesignController(IMediator mediator) : Controller
{
    ...
    public async Task<IActionResult> Edit(Guid id, CancellationToken ct)
    {
        ...
        var cmd = new UpdateMenuDesignCommand
        {
            ...
            CardBorderWidth = dto.CardBorderWidth,
            CardBackgroundColor = dto.CardBackgroundColor,
            CardImageBorderRadius = dto.CardImageBorderRadius,
            FooterBackgroundColor = dto.FooterBackgroundColor,
            FooterTextColor = dto.FooterTextColor,
            FooterButtonColor = dto.FooterButtonColor,
            FooterButtonStyle = dto.FooterButtonStyle,
            FontFamily = dto.FontFamily,
            BodyFontSize = dto.BodyFontSize,
            HeadingFontFamily = dto.HeadingFontFamily,
            HeadingFontSize = dto.HeadingFontSize,
            SubheadingFontSize = dto.SubheadingFontSize,
            HeadingTextColor = dto.HeadingTextColor,
            HeadingBorderWidth = dto.HeadingBorderWidth,
            HeadingBorderColor = dto.HeadingBorderColor,
            HeadingFontWeight = dto.HeadingFontWeight,
            LinkColor = dto.LinkColor,
            PriceColor = dto.PriceColor,
            ButtonTextColor = dto.ButtonTextColor,
            ButtonBorderColor = dto.ButtonBorderColor,
            ButtonBorderRadius = dto.ButtonBorderRadius,
            SurfaceOpacity = dto.SurfaceOpacity,
            CardOpacity = dto.CardOpacity,
            HeaderSecondaryTextOpacity = dto.HeaderSecondaryTextOpacity,
            HeaderAccentTextOpacity = dto.HeaderAccentTextOpacity,
            PageBackgroundOverlayOpacity = dto.PageBackgroundOverlayOpacity,
