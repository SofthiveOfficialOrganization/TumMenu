...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260821152946_AddCustomerOrderRequests")]
    partial class AddCustomerOrderRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("AcceptedKvkkVersion")
                        .HasMaxLength(64)
                    ...
                    b.Property<string>("LegalAcceptedUserAgent")
                        .HasMaxLength(512)
            ...
            modelBuilder.Entity("Domain.Entities.Company", b =>
                {
                    ...
                    b.Property<Guid?>("DefaultMainMenuId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex(new[] { "OwnerId" }, "IX_Companies_OwnerId_Active")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domain.Entities.CustomerOrderRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("QrOrderSessionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("QrOrderSessionId");

                    b.HasIndex("StoreId", "CreatedAt");

                    b.HasIndex("CompanyId", "Status", "CreatedAt");

                    b.ToTable("CustomerOrderRequests");
                });

            modelBuilder.Entity("Domain.Entities.CustomerOrderRequestItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ProductPriceSizeSnapshot")
                        .HasMaxLength(100)
                    ...
                    b.ToTable("CustomerOrderRequestItems");
                });
            ...
            modelBuilder.Entity("Domain.Entities.MenuDesign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CardBorderWidth")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("CountPillBackgroundColor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CountPillBorderColor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CountPillOpacity")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CountPillTextColor")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FooterButtonColor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FooterButtonStyle")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("HeadingBorderColor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HeadingBorderWidth")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HeadingFontFamily")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HeadingFontSize")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PhoneLinkColor")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SocialIconBackgroundColor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SocialIconBorderColor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SocialIconColor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SocialIconOpacity")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SortOrder")
                        .HasColumnType("int");

                    b.Property<string>("SubheadingFontSize")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.OwnerIssueReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CurrentPageTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.QrOrderSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Store", b =>
                {
                    ...
                    b.Property<bool>("ShowCoverPhotoOnQrMenu")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("ShowPricesOnMenu")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Domain.Entities.Company", b =>
                {
                    b.HasOne("Domain.Entities.Menu", "DefaultMainMenu")
                        .WithMany()
                        .HasForeignKey("DefaultMainMenuId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Domain.Entities.CustomerOrderRequest", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.QrOrderSession", "QrOrderSession")
                        .WithMany()
                        .HasForeignKey("QrOrderSessionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.CustomerOrderRequestItem", b =>
                {
                    b.HasOne("Domain.Entities.CustomerOrderRequest", "OrderRequest")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Domain.Entities.Menu", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.MenuDesign", "MenuDesign")
                        .WithMany("Menus")
                        .HasForeignKey("MenuDesignId")
                        .OnDelete(DeleteBehavior.SetNull);
