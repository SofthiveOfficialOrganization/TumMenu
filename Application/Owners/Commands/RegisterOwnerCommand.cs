...
public sealed record RegisterOwnerCommand(string Email, string UserName, string Password, string FirstName, string LastName) : IRequest<AuthResultDTO>, ITransactionalRequest;
