...
) : IRequestHandler<UpdateMenuDesignCommand, MenuDesign>
{
    public async Task<MenuDesign> Handle(UpdateMenuDesignCommand req, CancellationToken ct)
    {
        ...
        design.CountPillBackgroundColor = req.CountPillBackgroundColor;
        design.CountPillTextColor = req.CountPillTextColor;
        design.CountPillBorderColor = req.CountPillBorderColor;
        design.CountPillOpacity = req.CountPillOpacity;
        design.PhoneLinkColor = req.PhoneLinkColor;
        design.SocialIconColor = req.SocialIconColor;
        design.SocialIconBackgroundColor = req.SocialIconBackgroundColor;
        design.SocialIconBorderColor = req.SocialIconBorderColor;
        design.SocialIconOpacity = req.SocialIconOpacity;
